...
RSpec.describe "bulk discount deletion" do
  describe "as merchant employee" do
    ...
    it "can delete bulk discount" do
      ...
      expect(page).to_not have_content(@discount.min_item_quantity)
      expect(page).to_not have_content(@discount.percent_off)
    end
  end
end
